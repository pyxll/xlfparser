...
namespace Catch {
    ...
    namespace Generators {
        ...
        template<typename L>
        // Note: The type after -> is weird, because VS2015 cannot tokenize
...
// enum of result types from a tokenize
...
namespace Catch {
    ...
    #ifdef __linux__
    constexpr static std::size_t sigStackSize = 32768;  // MINSIGSTKSZ is not a constexpr 
    #else
